...
"""autogenerated by genpy from pose_graph_msgs/PoseGraph.msg. Do not edit."""
import sys
...
import pose_graph_msgs.msg
import std_msgs.msg

class PoseGraph(genpy.Message):
  _md5sum = "483fdea4a5d26454e6dac91a4e5db16c"
  _type = "pose_graph_msgs/PoseGraph"
...
"""
  ...
  _slot_types = ['std_msgs/Header','pose_graph_msgs/PoseGraphNode[]','pose_graph_msgs/PoseGraphEdge[]']
    ...
    try:
      ...
      for val1 in self.nodes:
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_Q().pack(val1.key))
        _v3 = val1.pose
        _v4 = _v3.position
        _x = _v4
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = pose_graph_msgs.msg.PoseGraphNode()
        _v6 = val1.header
        start = end
        end += 4
      ...
      self.edges = []
      for i in range(0, length):
        val1 = pose_graph_msgs.msg.PoseGraphEdge()
        _x = val1
        start = end
        end += 16
