...
class KeyedScan {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('scan')) {
        ...
        this.scan = new sensor_msgs.msg.PointCloud2();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = sensor_msgs.msg.PointCloud2.serialize(obj.scan, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new KeyedScan(null);
    // Deserialize message field [key]
    data.key = _deserializer.uint64(buffer, bufferOffset);
    // Deserialize message field [scan]
    data.scan = sensor_msgs.msg.PointCloud2.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += sensor_msgs.msg.PointCloud2.getMessageSize(object.scan);
    return length + 8;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new KeyedScan(null);
    ...
    if (msg.scan !== undefined) {
      resolved.scan = sensor_msgs.msg.PointCloud2.Resolve(msg.scan)
    }
    else {
      resolved.scan = new sensor_msgs.msg.PointCloud2()
    }
